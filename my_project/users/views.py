...
from flask_login import login_user, current_user, logout_user, login_user, login_required
from my_project import db
from my_project.models import User, BlogPost
